...
export function ResultSection({ result, onRetake }: ResultSectionProps) {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #0A0020 0%, #1A0040 40%, #3B1F6E 100%)",
      }}
    >
      {/* Ambient glow */}
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(120deg, transparent 40%, rgba(168,85,247,0.12) 60%, transparent 70%)",
        }}
      />
        ...
        >
          ...
          <div className="relative flex items-center justify-center p-10 md:p-14 min-h-[340px]">
            ...
            <div className="relative w-[260px] h-[260px] flex items-center justify-center">
              {/* Vinilo detrás, desplazado a la derecha */}
              <div
                className="absolute"
                style={{
                  width: "85%",
              ...
              {/* Portada encima, centrada */}
              <div className="relative w-[77%] h-[77%] rounded-lg overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.7)] z-10">
                <Image
          ...
          <div className="flex flex-col justify-center p-8 md:p-12">
            {/* "You are:" label */}
            <p className="text-white/50 text-sm font-body mb-1 tracking-wide">
              Eres:
            </p>
            ...
            <p className="text-white/30 text-xs mt-3">
              Edición limitada de colección disponible ahora
            </p>
